...
```{r keep}
# using the group is important because if something is missing from only one group, that might be interesting. 
...
```{r pca}
# gene.selection = common is a normal PCA
